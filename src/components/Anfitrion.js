...
const Anfitrion = () => {
  ...
  return (
    <div>
        ...
        <div class="header-anfitrion">
            <div class="div-anfitrion">
                <a href="/"><img src="https://res.cloudinary.com/travelingimg/image/upload/v1651730227/bird_2_xhqowt.png" alt="" class="img-header-anfitrion" /></a> 
                <h1>Se parte de la experiencia de los demas y oferta tu lugar</h1>

                <a href='login' class="btn-seanfitrion">Se anfitrion!</a>
            </div>
            <div class="img-anfitrion">
                <img src="https://res.cloudinary.com/travelingimg/image/upload/v1651732430/image_3_-_copia_fwsyd0.png" alt="" />
            </div>
        </div>

        <div>
            <div class="h1-servicio">
                <h1>Brinda los mejores opciones y servicios como anfitrio a tus residentes.</h1>
            </div>
            <div class="div-imgs-servicio">
        ...
        <div class="div-se-anfitrion">
            <a href=''> <img src="https://res.cloudinary.com/travelingimg/image/upload/v1651736096/banner_fgs0kc.png" alt="" /></a>
        </div>
